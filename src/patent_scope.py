...
(figure-view helpers live in src/figure_views.py and are re-exported here)
...
from src.figure_views import (          # noqa: F401
    split_drawing_lines, classify_figure_views, summarise_figure_views,
    FIGURE_VIEW_OPTIONS,
)
